...
for value in check_first_truck():
    check_first_truck()[i][9] = first_time
    ...
    for k in first_truck_delivery_list:
        for j in Distances.check_address():
            if k[2] == j[2]:
                ...
                first_truck_delivery_list[first_truck_count][1] = j[0]
        first_truck_count += 1
except IndexError:
    pass
#Sorting Packages *************************************************************************
...
for index in range(len(first_truck_final_index())):
    try:
       
        first_truck_total_distance = check_distances(int(first_truck_final_index()[index]), int(first_truck_final_index()[index + 1]), first_truck_total_distance)
        ...
        first_truck_final_list()[first_truck_package_id][10] = (str(deliver_package))
...
for value in check_second_truck():
    check_second_truck()[i][9] = second_time
    ...
    for k in second_truck_delivery_list:
        for j in Distances.check_address():
            if k[2] == j[2]:
                ...
                second_truck_delivery_list[second_truck_count][1] = j[0]
...
for index in range(len(second_truck_final_index())):
    try:
        ...
        get_hash_map().update(int(second_truck_final_list()[second_truck_package_id][0]),second_truck_delivery_list)
...
for value in check_third_truck():
    check_third_truck()[i][9] = third_time
    ...
    for k in third_truck_delivery_list:
        for j in Distances.check_address():
            if k[2] == j[2]:
                ...
                third_truck_delivery_list[third_truck_count][1] = j[0]
        third_truck_count += 1
except IndexError:
    pass
#Sorting Packages *************************************************************************
#This uses the greedy algorithm to sort the packages into the best order for each truck	
#Truck 3  ***********
...
for index in range(len(third_truck_final_index())):
    try:
        ...
        third_truck_final_list()[third_truck_package_id][10] = (str(deliver_package))
        get_hash_map().update(int(third_truck_final_list()[third_truck_package_id][0]), third_truck_delivery_list)
...
def total_distances():
    total_distances = first_truck_total_distance + second_truck_total_distance + third_truck_total_distance
